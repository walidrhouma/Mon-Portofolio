...
LOG_FILE="/home/walid/LOG/sauvegarde_SITE.log"
REPERTOIRE_SOURCE="/home/walid/SITE"
SERVEUR_STOCKAGE="192.168.0.100"
REPERTOIRE_DEST="/home/sauvegarde/SITE"
...
ssh -i $KEY_PATH sauvegarde@$SERVEUR_STOCKAGE "
    ...
    find $REPERTOIRE_DEST/ARCHIVES -type d -mtime +30 -exec rm -rf {} +
" >> $LOG_FILE
