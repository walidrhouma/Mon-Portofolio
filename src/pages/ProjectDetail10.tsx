...
export default function ProjectDetail10() {
  ...
  const toolsList = [
    ...
    { 
      ...
      icon: Server,
      color: "text-cyber-emerald bg-cyber-emerald/10 border-cyber-emerald/30"
    },
    { 
      name: "Rsyslog & Rsync", 
      ...
      icon: HardDrive,
      color: "text-cyber-blue bg-cyber-blue/10 border-cyber-blue/30"
    },
    { 
  ...
  return (
    <div className="min-h-screen bg-base-900 text-slate-200">
      <div className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Normes ANSSI</h3>
            <p className="text-xs text-slate-400">Cartographie, DMZ & VLANs</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">Stormshield SN510</h3>
            <p className="text-xs text-slate-400">Pare-feu, IPS/IDS & Proxy</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">8 768,02 € HT</h3>
            <p className="text-xs text-slate-400">Devis respectant l'enveloppe de 10k€</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">HPE DL20 & ML30</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-base-700/80 border border-cyber-blue/30 rounded-2xl p-6 md:p-8 backdrop-blur-md space-y-8 shadow-xl shadow-glow">
              ...
              {activeProofTab === 'architecture' && (
                <div className="space-y-6">
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-bold font-mono transition-all border ${
                        archSubTab === 'target'
                          ...
                          : 'bg-base-700 text-slate-400 border-white/5 hover:text-white'
                      }`}
                    >
                  ...
                  {archSubTab === 'target' ? (
                    <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                        <div className="p-3 bg-base-700/80 rounded-lg border border-white/5 space-y-1">
                          <span className="font-bold text-cyber-blue">Segmentation VLANs Déployée :</span>
                        ...
                        <div className="p-3 bg-base-700/80 rounded-lg border border-white/5 space-y-1">
                          <span className="font-bold text-cyber-emerald">Contrôle des Flux & Pare-feu :</span>
                          <ul className="list-disc list-inside text-slate-300 text-[11px] space-y-0.5">
                    ...
                    <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-4">
                      ...
                      <div className="p-3 bg-base-700/80 rounded-lg border border-amber-500/30 text-xs space-y-1">
              ...
              {activeProofTab === 'baie' && (
                <div className="space-y-6">
                  <div className="p-5 rounded-xl bg-base-900 border border-white/5 space-y-4">
                    ...
                    <div className="rounded-lg overflow-hidden border border-white/5 bg-white p-3 flex justify-center">
                      <img 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2 text-xs">
                      <div className="p-3 bg-base-700/80 rounded-lg border border-white/5 space-y-1">
                        <span className="font-bold text-cyber-blue">Switch 48 Ports :</span>
                      ...
                      <div className="p-3 bg-base-700/80 rounded-lg border border-white/5 space-y-1">
                        <span className="font-bold text-cyber-emerald">HPE ProLiant DL20 :</span>
              ...
              {activeProofTab === 'plan' && (
                <div className="space-y-6">
                  ...
                  {/* Tableau Devis */}
                  <div className="p-5 rounded-xl bg-base-900 border border-white/5 space-y-4">
                    <h3 className="text-sm font-bold text-cyber-emerald flex items-center gap-2">
                      <FileText className="w-4 h-4" />
                      Devis Presta IT N° DEVIS-IT-001 (Matériel)
                    </h3>

                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-xs font-mono border-collapse">
                        <thead>
                          <tr className="border-b border-white/5 bg-base-700 text-cyber-blue">
                        ...
                        <tbody className="divide-y divide-white/5 text-slate-300">
                          <tr>
                            ...
                            <td className="p-2.5 text-right font-bold text-cyber-emerald">3 248,00 €</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td className="p-2.5 text-right font-bold text-cyber-emerald">832,28 €</td>
                          </tr>
                          <tr>
                            <td className="p-2.5 font-semibold text-white">Câblage (Cordon RJ45 Cat6 & Jarretière optique)</td>
                            <td className="p-2.5">16 + 1</td>
                            <td className="p-2.5">Var.</td>
                            <td className="p-2.5 text-right font-bold text-cyber-emerald">69,25 €</td>
                          </tr>
                          <tr className="bg-base-700/90 font-bold text-white">
                            <td colSpan={3} className="p-2.5 text-right text-cyber-blue">TOTAL MATÉRIEL FACTURÉ HT (Max 10 000 €) :</td>
                            <td className="p-2.5 text-right text-cyber-emerald text-sm">8 768,02 € HT</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>

                    <div className="p-3 bg-base-700/60 rounded-lg border border-white/5 text-[11px] text-slate-400 space-y-1">
              ...
              {activeProofTab === 'doc' && (
                <div className="p-5 rounded-xl bg-base-900 border border-white/5 space-y-4">
                  ...
                  <div className="space-y-3 text-xs text-slate-300">
                    <div className="p-3 bg-base-700/60 rounded-lg border border-white/5 space-y-1">
                ...
                <div className="p-5 rounded-xl bg-base-900 border border-white/5 space-y-4">
                  ...
                  <div className="space-y-3">
                    {anssiGuides.map((guide, gIdx) => (
                      <div key={gIdx} className="p-3.5 bg-base-700/60 rounded-lg border border-white/5 space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="inline-flex items-center gap-1 text-[11px] font-mono text-cyber-blue hover:underline shrink-0"
                          >
                            Consulter
                        ...
                        <p className="text-[11px] text-slate-300">
                          <span className="font-semibold text-cyber-emerald">Parties appliquées : </span>
                          {guide.appliedPart}
                        </p>
                      </div>
                    ))}
            ...
            <div className="bg-base-800 border border-white/5 rounded-2xl p-6 md:p-8 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">
                      Évaluateur : <span className="text-slate-200 font-medium">Yacouba Diabira</span> • Étudiant : <span className="text-cyber-blue font-medium">Walid Rhouma</span>
                    </p>
                  </div>
                </div>

                <span className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full bg-cyber-emerald/10 text-cyber-emerald border border-cyber-emerald/30 self-start md:self-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-white">1. Planifier un projet de sécurisation d'infrastructure</span>
                      <span className="text-[11px] font-bold text-cyber-emerald bg-cyber-emerald/10 px-2 py-0.5 rounded border border-cyber-emerald/30">✅ Validé</span>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                ...
                <div className="p-4 rounded-xl bg-cyber-emerald/10/60 border border-cyber-emerald/30 space-y-2">
                  <h4 className="text-xs font-bold text-cyber-emerald flex items-center gap-1.5">
                ...
                <div className="p-4 rounded-xl bg-amber-500/10/60 border border-amber-500/30 space-y-2">
              ...
              {/* Conclusion du jury */}
              <div className="p-4 rounded-xl bg-base-900 border border-cyber-blue/30 space-y-1 text-xs text-slate-300">
                <span className="font-bold text-cyber-blue">Conclusion globale de l'évaluateur :</span>
          ...
          <div className="space-y-6">
                ...
                {toolsList.map((item, i) => {
                  ...
                  return (
                    <div key={i} className="p-3 rounded-xl bg-base-900/50 border border-white/5 flex items-center justify-between hover:border-white/10 transition-colors">
                      ...
                      <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-base-700 text-slate-400 border border-white/5 shrink-0 ml-2">
                        {item.badge}
                      </span>
                    </div>
                  );
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 backdrop-blur-sm space-y-3">
              ...
              <div className="space-y-2">
                {anssiGuides.map((guide, idx) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-between p-2.5 rounded-lg bg-base-900/60 border border-white/5 hover:border-cyber-blue/50 text-xs text-slate-300 hover:text-cyber-blue transition-all group"
                  >
      ...
      <EvaluationJury
        evaluator={"Yacouba Diabira"}
        summary={"Soutenance orale de 35 minutes."}
        quote={"Les competences evaluees ont toutes ete validees. La presentation est claire et les choix techniques sont bien justifies."}
      />
      <ProjectFooterNav current={10} />
    </div>
  );
}