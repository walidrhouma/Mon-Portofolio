      ...
      <div className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Architecture AGDLP</h3>
            <p className="text-xs text-slate-400">Groupes Globaux & Domaine Local stricts</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">Automation Ansible</h3>
            <p className="text-xs text-slate-400">Playbooks maj systems & apps</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">GLPI & Inventaire</h3>
            <p className="text-xs text-slate-400">Remontée agents VM Windows / Linux</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">100% Conforme</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
              ...
              <div className="p-4 rounded-xl bg-base-900/70 border border-white/5 space-y-2">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
              <h2 className="text-xl font-bold text-white flex items-center gap-3">
                <span className="p-1 rounded-full bg-cyber-blue/10 text-cyber-blue border border-cyber-blue/20">
              ...
              <div className="space-y-4">
                ...
                {/* Action 1 */}
                <div className="p-5 rounded-xl bg-base-900/60 border border-white/5 flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-base-700 border border-white/5 text-cyber-blue shrink-0 mt-0.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed">
                      Organisation structurée des Unités Organisationnelles (OU), gestion des utilisateurs et mise en place rigoureuse des groupes Globaux (<code className="text-amber-300">G_</code>) imbriqués dans les groupes Domaine Local (<code className="text-cyber-emerald">DL_</code>) pour un contrôle d'accès strict aux partages réseau NTFS.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-base-700/80 border border-cyber-blue/30 rounded-2xl p-6 md:p-8 backdrop-blur-md space-y-8 shadow-xl shadow-glow">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
                <div className="p-3 rounded-xl bg-base-900/80 border border-white/5 text-center space-y-1">
                  <span className="text-slate-400 text-[10px] uppercase block">Target Hosts</span>
                  <span className="text-cyber-blue font-bold text-sm">Win10 & Ubuntu</span>
                </div>
                <div className="p-3 rounded-xl bg-base-900/80 border border-white/5 text-center space-y-1">
                  <span className="text-slate-400 text-[10px] uppercase block">Auth Protocol</span>
                  <span className="text-cyber-emerald font-bold text-sm">Kerberos sec=krb5</span>
                </div>
                <div className="p-3 rounded-xl bg-base-900/80 border border-white/5 text-center space-y-1">
              ...
              {/* Barre d'onglets */}
              <div className="flex border-b border-white/5 gap-2 overflow-x-auto text-xs font-mono pb-1">
                <button 
                  ...
                  className={`px-4 py-2 rounded-t-lg transition-all flex items-center gap-2 font-semibold ${
                    activeProofTab === 'ansible' 
                      ? 'bg-cyber-blue/10 text-cyber-blue border-t border-x border-cyber-blue' 
                      : 'text-slate-400 hover:text-slate-200 hover:bg-base-700/50'
                  }`}
                >
              ...
              {activeProofTab === 'ansible' && (
                <div className="space-y-4">
                  <div className="rounded-xl bg-base-900 border border-white/5 overflow-hidden shadow-2xl">
                    <div className="bg-base-700 px-4 py-2 border-b border-white/5 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono text-cyber-emerald bg-cyber-emerald/10 px-2 py-0.5 rounded border border-cyber-emerald">
                    ...
                    <div className="p-4 font-mono text-[11px] leading-relaxed space-y-4 text-slate-300 overflow-x-auto">
                      <div>
                        <p className="text-cyber-blue font-bold">$ ansible-playbook -i inventory/hosts playbooks/install_color_contrast_analyser.yml</p>
                        ...
                        <p className="text-cyber-emerald font-bold mt-1">PLAY RECAP: 192.168.0.40 : ok=3 changed=2 unreachable=0 failed=0</p>
                      </div>
                      ...
                      <div className="pt-3 border-t border-white/5">
                        ...
                        <p className="text-cyber-emerald font-bold mt-1">PLAY RECAP: 192.168.0.20 : ok=2 changed=1 unreachable=0 failed=0</p>
                      </div>

                      <div className="pt-3 border-t border-white/5">
                        <p className="text-cyber-blue font-bold">$ ansible-playbook -i inventory/hosts playbooks/maj_ubuntu.yml</p>
                        ...
                        <p className="text-cyber-emerald font-bold mt-1">PLAY RECAP: 192.168.0.20 : ok=4 changed=2 unreachable=0 failed=0</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeProofTab === 'agdlp' && (
                <div className="space-y-4">
                  <div className="p-5 rounded-xl bg-base-900 border border-white/5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-xs font-mono">
                      <div className="p-3 rounded-lg bg-base-700 border border-cyber-blue/30 space-y-1">
                        <span className="text-cyber-blue font-bold block text-[11px]">[A] Accounts</span>
                        <p className="text-slate-300 text-[11px]">walid.rhouma</p>
                        <p className="text-slate-300 text-[11px]">comptes utilisateurs</p>
                      </div>

                      <div className="p-3 rounded-lg bg-base-700 border border-amber-500/30 space-y-1">
                      ...
                      <div className="p-3 rounded-lg bg-base-700 border border-cyber-emerald/30 space-y-1">
                        <span className="text-cyber-emerald font-bold block text-[11px]">[DL] Domain Local</span>
                        <p className="text-slate-300 text-[11px]">DL_Partage_Service_RW</p>
                        <p className="text-slate-300 text-[11px]">DL_Partage_User_RW</p>
                      </div>

                      <div className="p-3 rounded-lg bg-base-700 border border-purple-800/60 space-y-1">
                    ...
                    <div className="p-3 rounded-lg bg-base-700/60 border border-white/5 text-xs text-slate-300 space-y-1">
                      <span className="font-bold text-cyber-blue">Règle appliquée :</span>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
                    ...
                    <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-2">
                      <div className="flex items-center justify-between text-cyber-emerald font-bold border-b border-white/5 pb-2">
    ...
    Write-Host "Erreur lors du montage."
              ...
              {activeProofTab === 'screenshots' && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                  <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-3 flex flex-col justify-between">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="inline-flex items-center justify-center gap-1.5 w-full py-2 rounded-lg bg-base-700 hover:bg-base-700 text-cyber-blue font-mono text-[11px] border border-white/5 transition-colors"
                    >
                  ...
                  <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-3 flex flex-col justify-between">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-cyber-emerald font-bold">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="inline-flex items-center justify-center gap-1.5 w-full py-2 rounded-lg bg-base-700 hover:bg-base-700 text-cyber-emerald font-mono text-[11px] border border-white/5 transition-colors"
                    >
                  ...
                  <div className="p-4 rounded-xl bg-base-900 border border-white/5 space-y-3 flex flex-col justify-between">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="inline-flex items-center justify-center gap-1.5 w-full py-2 rounded-lg bg-base-700 hover:bg-base-700 text-purple-400 font-mono text-[11px] border border-white/5 transition-colors"
                    >
            ...
            <div className="bg-gradient-to-br from-base-700/60 via-base-700/40 to-cyber-emerald/10 border border-cyber-emerald/30 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-cyber-emerald font-medium">Soutenance Validée — Anthony Borg</p>
                </div>
              </div>

              <div className="p-4 rounded-xl bg-base-900/80 border border-white/5 text-xs text-slate-300 space-y-2">
                  ...
                  <div key={i} className="p-3 rounded-xl bg-base-900/50 border border-white/5 flex items-center justify-between hover:border-white/10 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 p-1.5 rounded-lg bg-base-700 border border-white/5 shrink-0 flex items-center justify-center">
                        {item.isAdSvg ? (
                          <svg className="w-6 h-6 text-cyber-blue" viewBox="0 0 24 24" fill="currentColor">
      ...
      <EvaluationJury
        evaluator={"Anthony Borg"}
        summary={"Projet majeur — soutenance validee sans reserve."}
        quote={"Une bonne soutenance. Walid a presente l'ensemble des points abordés : contexte, AD, permissions, chiffrement BitLocker et Linux, scripts Ansible. Bravo pour ce travail realise avec serieux !"}
      />
      <ProjectFooterNav current={8} />
    </div>
  );
}