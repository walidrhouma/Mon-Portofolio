...
const highlights = [
  ...
  desc: '13 projets OpenClassrooms validés, dont 12 présentés dans ce portfolio, couvrant systèmes, réseaux, sécurité et cloud.',
},
  {
    icon: CheckCircle2,
  ...
  <div className="rounded-3xl bg-base-700/40 border border-white/5 p-8 lg:p-12 relative overflow-hidden">
    ...
    <div className="max-w-5xl relative z-10">
      ...
      <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
        <p>
          Administrateur Systèmes & Réseaux, mon parcours combine plus de
          6 ans d'expérience terrain avec une formation Bac+4 RNCP en
          systèmes, réseaux et sécurité chez OpenClassrooms.
        </p>

        <p>
          J'ai notamment évolué sur des environnements professionnels
          exigeants au <strong className="text-white">Ministère de la Justice</strong>{' '}
          (via SCC) et chez <strong className="text-white">Canal+</strong>{' '}
          (via Helpline), avec des interventions autour d'Active Directory,
          des GPO, de Microsoft 365/Exchange, de SCCM et de la sécurisation
          des postes.
        </p>

        <p>
          Cette expérience a été complétée par la réalisation de projets
          techniques couvrant les systèmes Windows/Linux, les réseaux,
          la sécurité, la virtualisation, l'automatisation et le cloud.
        </p>
      </div>

      {/* Parcours & continuité technique */}
      <div className="mt-10 pt-8 border-t border-white/10">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-7">
          <div>
            <span className="text-sm font-mono text-cyber-emerald uppercase tracking-wider">
              Parcours & continuité technique
            </span>

            <h3 className="text-xl sm:text-2xl font-bold text-white mt-2">
              De l'expérience terrain à l'administration d'infrastructures
            </h3>
          </div>

          <span className="text-xs font-mono text-slate-500">
            EXPÉRIENCE → COMPÉTENCES → OBJECTIF
          </span>
        </div>

        <div className="relative">
          {/* Ligne de connexion entre les étapes */}
          <div className="hidden md:block absolute top-[43px] left-[14%] right-[14%] h-px bg-gradient-to-r from-cyber-blue/40 via-cyber-emerald/50 to-cyber-blue/40" />

          <div className="grid md:grid-cols-3 gap-5 relative">

            {/* Étape 01 */}
            <div className="group relative rounded-2xl bg-slate-900/60 border border-cyber-blue/10 hover:border-cyber-blue/40 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-cyber-blue/5">
              <div className="flex items-center justify-between mb-5">
                <div className="relative z-10 w-14 h-14 rounded-2xl bg-slate-950 border border-cyber-blue/30 flex items-center justify-center shadow-lg shadow-cyber-blue/5">
                  <span className="text-cyber-blue font-mono text-lg font-bold">
                    01
                  </span>
                </div>

                <span className="text-xs font-mono text-cyber-blue/50">
                  TERRAIN
                </span>
              </div>
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Support N2 et administration systèmes junior sur des
                environnements professionnels : Active Directory, GPO,
                Microsoft 365, SCCM, Exchange et postes sécurisés.
              </p>
            ...
            {/* Étape 02 */}
            <div className="group relative rounded-2xl bg-slate-900/60 border border-cyber-emerald/10 hover:border-cyber-emerald/40 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-cyber-emerald/5">
              <div className="flex items-center justify-between mb-5">
                <div className="relative z-10 w-14 h-14 rounded-2xl bg-slate-950 border border-cyber-emerald/30 flex items-center justify-center shadow-lg shadow-cyber-emerald/5">
                  <span className="text-cyber-emerald font-mono text-lg font-bold">
                    02
                  </span>
                </div>

                <span className="text-xs font-mono text-cyber-emerald/50">
                  FORMATION
                </span>
              </div>
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Formation Bac+4 RNCP et réalisation de 13 projets
                OpenClassrooms permettant de consolider les compétences
                systèmes, réseaux, sécurité, automatisation et cloud.
              </p>

              <div className="mt-5 pt-4 border-t border-white/5">
                <span className="text-xs text-cyber-emerald font-mono">
                  13 PROJETS · SYSTÈMES · RÉSEAUX
                </span>
              </div>
            </div>

            {/* Étape 03 */}
            <div className="group relative rounded-2xl bg-slate-900/70 border border-cyber-blue/30 hover:border-cyber-blue/60 p-6 transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-cyber-blue/5">
              <div className="flex items-center justify-between mb-5">
                <div className="relative z-10 w-14 h-14 rounded-2xl bg-cyber-blue/10 border border-cyber-blue/50 flex items-center justify-center shadow-lg shadow-cyber-blue/10">
                  <span className="text-cyber-blue font-mono text-lg font-bold">
                    03
                  </span>
                </div>
              ...
              <p className="text-sm text-slate-300 leading-relaxed">
                Objectif : mettre cette double approche au service de
                l'administration systèmes & réseaux, du MCO, de la
                sécurisation des infrastructures et de leur automatisation.
              </p>

              <div className="mt-5 pt-4 border-t border-cyber-blue/10">
                <span className="text-xs text-cyber-blue font-mono">
                  MCO · SÉCURITÉ · AUTOMATISATION
                </span>
              </div>
            </div>
