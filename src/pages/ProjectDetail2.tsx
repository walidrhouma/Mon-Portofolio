...
import { 
  ...
  ExternalLink, Lock, Router, FileCode, ShieldAlert, Eye
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-base-900 text-slate-200">
      <div className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Hill Start</h3>
            <p className="text-xs text-slate-400">Bâtiment 130 rue de Lourmel</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">Cisco Packet Tracer</h3>
            <p className="text-xs text-slate-400">Simulation &amp; Topologie</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Dossier Technique</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                ...
                <div className="p-4 rounded-xl bg-base-900/40 border border-white/5 flex flex-col justify-between space-y-4">
                  <div>
                    <h3 className="text-sm font-semibold text-cyber-blue mb-1">Architecture Physique</h3>
                  ...
                  <div 
                    ...
                    className="relative group cursor-pointer overflow-hidden rounded-lg border border-white/5 bg-base-700 h-40 flex items-center justify-center"
                  >
                    <img 
                    ...
                    />
                    <div className="absolute inset-0 bg-base-900/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-1.5 text-xs font-medium text-cyber-blue">
                ...
                <div className="p-4 rounded-xl bg-base-900/40 border border-white/5 flex flex-col justify-between space-y-4">
                  <div>
                    <h3 className="text-sm font-semibold text-cyber-blue mb-1">Architecture Logique</h3>
                  ...
                  <tbody className="divide-y divide-white/5">
                    {vlanData.map((row, index) => (
                      <tr key={index} className="hover:bg-base-700/30 transition-colors">
                        <td className="py-3 px-4 font-semibold text-cyber-blue">{row.vlan}</td>
                        ...
                        <td className="py-3 px-4">
                          <span className="px-2 py-0.5 text-xs rounded-md bg-base-700 text-slate-300 border border-white/10">
                            {row.type}
                          </span>
                        </td>
                      </tr>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 backdrop-blur-sm space-y-4">
              ...
              <div className="p-4 rounded-xl bg-base-900/50 border border-white/5 hover:border-cyber-blue/30 transition-all flex flex-col gap-4 group">
                <div className="flex items-start gap-3">
                  <div className="p-2.5 rounded-lg bg-red-500/10 text-red-400 border border-red-500/20 shrink-0">
                    <FileText className="w-6 h-6" />
                  </div>
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold text-white group-hover:text-cyber-blue transition-colors">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-base-700 px-3 py-2.5 text-xs font-medium text-slate-200 hover:text-white hover:bg-base-600 transition-all"
                  >
                  ...
                  <a
                    href="/docs/Projet2/Rhouma_Walid_DAT_042024.pdf"
                    download
                    className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-cyber-blue/10 text-cyber-blue border border-cyber-blue/20 px-3 py-2.5 text-xs font-semibold hover:bg-cyber-blue hover:text-white transition-all"
                  >
            ...
            <div className="bg-gradient-to-br from-base-700/60 via-base-700/40 to-cyber-blue/10 border border-cyber-blue/30 rounded-2xl p-6 backdrop-blur-sm space-y-4 shadow-lg shadow-glow">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-cyber-blue font-medium">Référentiel officiel ANSSI</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {[
                  { 
                    ...
                    icon: <Router className="w-5 h-5 text-cyber-blue" />,
                    badge: "Cisco"
                  },
                  { 
                    name: "IPv4 / CIDR / VLANs", 
                    desc: "Plan d'adressage & Segmentation",
                    icon: <Network className="w-5 h-5 text-cyber-emerald" />,
                    badge: "Protocole"
                  },
                  { 
      ...
      <EvaluationJury
        ...
        summary={"Competences validees : cartographie reseau et construction TCP-IP."}
        quote={"Schema logique valide, schema physique valide, plan adressage valide. Bonne qualite des livrables presentes lors de la soutenance."}
      />
      <ProjectFooterNav current={2} />
    </div>
  );
}