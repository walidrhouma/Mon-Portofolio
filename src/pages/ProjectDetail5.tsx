  ...
  return (
    <div className="min-h-screen bg-base-900 text-slate-200">
      <div className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Windows Server 2019</h3>
            <p className="text-xs text-slate-400">AD DS & Contrôleur de Domaine</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">RODC & pfSense</h3>
            <p className="text-xs text-slate-400">Site Distant (Nantes)</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">PowerShell & Cloud</h3>
                  ...
                  <div className="space-y-1 text-[11px]">
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_1_copie_ecran_PC_062024.png" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_1_copie_ecran_PC_062024.png" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_2_copie_ecran_utilisateurs_062024.png" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_2_copie_ecran_utilisateurs_062024.png" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_3_copie_ecran_gpo_062024.png" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_3_copie_ecran_gpo_062024.png" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-base-900/60 border border-white/5 space-y-2">
                  ...
                  <div className="space-y-1 text-[11px]">
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/config-pfsense1-openbank-20240629192952.xml" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/config-pfsense1-openbank-20240629192952.xml" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/config-pfsense2-openbank-20240629193134.xml" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/config-pfsense2-openbank-20240629193134.xml" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/Pfsense_Nantes.png" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/Pfsense_Nantes.png" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/Pfsense_Paris.png" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet5/Rhouma_Walid_4_copie_ecran_config_VPN_062024/Pfsense_Paris.png" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <EvaluationJury
        ...
        quote={"Projet valide ! Excellente maitrise de l architecture Active Directory et du controleur RODC distant. Le script PowerShell vers le Cloud est parfaitement operationnel."}
      />
      <ProjectFooterNav current={5} />
    </div>
  );
}