  ...
  const deliverables = [
    {
      ...
      type: "PDF",
      color: "border-cyber-blue/20 bg-cyber-blue/10 text-cyber-blue"
    },
    {
      ...
      type: "PDF",
      color: "border-cyber-emerald/20 bg-cyber-emerald/10 text-cyber-emerald"
    },
    {
    ...
    <div className="min-h-screen bg-base-900 text-slate-200">
      <div className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">AWS Cloud</h3>
            <p className="text-xs text-slate-400">Infrastructure Cible</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">Haute Dispo</h3>
            <p className="text-xs text-slate-400">Multi-AZ &amp; Auto Scaling</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">TCO &amp; Budget</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
              ...
              <div className="space-y-4 pt-2">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-base-900/40 border border-white/5 space-y-2">
                  ...
                  <div className="p-4 rounded-xl bg-base-900/40 border border-white/5 space-y-2">
                    <h3 className="text-sm font-semibold text-cyber-emerald flex items-center gap-2">
                ...
                <div 
                  ...
                  className="relative group cursor-pointer overflow-hidden rounded-xl border border-white/5 bg-base-900 p-2 text-center"
                >
                  <img 
                  ...
                  />
                  <div className="absolute inset-0 bg-base-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 text-xs font-semibold text-cyber-blue backdrop-blur-[2px]">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {cloudBenchmarkData.map((row, index) => (
                      <tr key={index} className="hover:bg-base-700/30 transition-colors">
                        <td className="py-3 px-4 font-semibold text-cyber-blue font-mono">{row.id}</td>
                        ...
                        <td className="py-3 px-4">
                          <span className={`px-2 py-0.5 text-xs rounded-md font-semibold border ${
                            row.verdict.includes('Retenue') 
                              ? 'bg-cyber-emerald/10 text-cyber-emerald border-cyber-emerald' 
                              : 'bg-base-700 text-slate-300 border-white/10'
                          }`}>
                            {row.verdict}
                          </span>
                        </td>
              ...
              <div className="p-4 rounded-xl bg-base-900/50 border border-white/5 space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-300">
                  <div className="p-3 rounded-lg bg-base-700 border border-white/5 space-y-1">
                    <span className="font-semibold text-cyber-blue block">Ressources Internes (Masse Salariale)</span>
                  ...
                  <div className="p-3 rounded-lg bg-base-700 border border-white/5 space-y-1">
                    <span className="font-semibold text-cyber-emerald block">Prestations Extérieures &amp; Run (HT)</span>
                    <p className="text-slate-300 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 backdrop-blur-sm space-y-4">
              ...
              <div className="space-y-3">
                {deliverables.map((doc, idx) => (
                  <div key={idx} className="p-4 rounded-xl bg-base-900/50 border border-white/5 hover:border-cyber-blue/30 transition-all flex flex-col gap-3 group">
                    <div className="flex items-start gap-3">
                      <div className={`p-2.5 rounded-lg border shrink-0 ${doc.color}`}>
                        <FileText className="w-5 h-5" />
                      </div>
                      <div className="space-y-0.5">
                        <h4 className="text-xs font-semibold text-white group-hover:text-cyber-blue transition-colors">
                          {doc.title}
                        </h4>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-base-700 hover:bg-base-600 text-slate-200 border border-white/10 transition-all text-xs font-semibold"
                      >
                      ...
                      <a
                        href={doc.path}
                        download
                        className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-cyber-blue/10 text-cyber-blue border border-cyber-blue/20 hover:bg-cyber-blue/90 hover:text-white transition-all text-xs font-semibold"
                      >
            ...
            <div className="bg-gradient-to-br from-base-700/60 via-base-700/40 to-cyber-blue/10 border border-cyber-blue/30 rounded-2xl p-6 backdrop-blur-sm space-y-4 shadow-lg shadow-glow">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-cyber-blue/10 text-cyber-blue border border-cyber-blue/20">
                ...
                <div>
                  ...
                  <p className="text-xs text-cyber-blue font-medium">Recommandations ANSSI</p>
                </div>
              </div>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full p-3 rounded-xl bg-cyber-blue/10 border border-cyber-blue/30 hover:bg-cyber-blue/20 transition-all flex items-center justify-between group block"
              >
                <div className="space-y-0.5">
                  <span className="text-xs font-bold text-white group-hover:text-cyber-blue transition-colors flex items-center gap-1.5">
                    Guide Cloud ANSSI
                    <ExternalLink className="w-3.5 h-3.5" />
                  </span>
                  <span className="text-[11px] text-slate-300 block">Consulter les recommandations officielles</span>
                </div>
                <div className="w-8 h-8 rounded-lg bg-cyber-blue/20 flex items-center justify-center text-cyber-blue group-hover:scale-105 transition-transform">
                  ☁️
                </div>
              </a>
            </div>
              ...
              <div className="space-y-3">
                {toolsList.map((item, i) => (
                  <div key={i} className="p-3 rounded-xl bg-base-900/50 border border-white/5 flex items-center justify-between hover:border-white/10 transition-colors">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-base-700 text-slate-300 border border-white/5">
                      {item.badge}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-gradient-to-br from-base-700/60 via-base-700/40 to-cyber-emerald/10 border border-cyber-emerald/30 rounded-2xl p-6 backdrop-blur-sm space-y-4 shadow-lg shadow-glow">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-cyber-emerald font-medium">Soutenance orale de projet</p>
                </div>
              </div>

              <div className="space-y-3 text-xs text-slate-300">
                <div className="space-y-1.5">
                  <span className="font-semibold text-cyber-emerald block">Compétences évaluées :</span>
                ...
                <div className="p-3 rounded-lg bg-base-900/60 border border-white/5 space-y-1.5">
                  <span className="font-semibold text-cyber-blue block">Livrables :</span>
                  <p className="text-[11px] text-slate-300 leading-relaxed">
                ...
                <div className="p-3 rounded-lg bg-base-900/60 border border-white/5 space-y-1.5">
                  <span className="font-semibold text-cyber-emerald block">Soutenance :</span>
                  <p className="text-[11px] text-slate-300 leading-relaxed">
      ...
      {selectedImage && (
        <div 
          ...
          className="fixed inset-0 z-50 bg-base-900/80 backdrop-blur-md flex items-center justify-center p-4 cursor-pointer"
          role="dialog"
          aria-label="Aperçu agrandi de l'image"
        >
          <div className="relative max-w-5xl max-h-[90vh] bg-base-700 border border-white/5 rounded-2xl p-4 overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <button 
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 z-10 px-3 py-1.5 bg-base-700 hover:bg-base-600 text-white rounded-lg text-xs font-medium transition-colors"
            >
              Fermer ✕
            </button>
            <img 
      ...
      <EvaluationJury
        ...
        summary={"Competences validees : pilotage SI et veille technologique."}
        quote={"Projet valide. Les deux competences du bloc ont ete validees lors de la soutenance."}
      />
      <ProjectFooterNav current={12} />
    </div>
  );
}