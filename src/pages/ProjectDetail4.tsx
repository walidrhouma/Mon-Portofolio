...
export default function ProjectDetail4() {
  ...
  return (
    <div className="min-h-screen bg-base-900 text-slate-200">
      <div className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Rainbow Bank</h3>
            <p className="text-xs text-slate-400">Projet EXTRANET / DIL</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-emerald">HTTPD & FTPS</h3>
            <p className="text-xs text-slate-400">Services Web & Transfert</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">Netfilter & Fail2Ban</h3>
            <p className="text-xs text-slate-400">Hardening & Anti-DDoS</p>
          </div>
          <div className="p-5 rounded-2xl bg-base-700/60 border border-white/5 backdrop-blur-sm space-y-1">
            <h3 className="text-lg font-bold text-cyber-blue">100% Validé</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
              ...
              <div className="p-4 rounded-xl bg-base-900/50 border border-white/5 space-y-3">
                <h3 className="text-sm font-semibold text-cyber-blue flex items-center gap-2">
                  <Cpu className="w-4 h-4" />
                  Analyses Techniques Clés Approfondies
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-300">
                  <div className="p-3 rounded-lg bg-base-700/80 border border-white/5">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-3.5 p-3.5 rounded-xl bg-base-900/40 border border-white/5">
                    <div className="p-1 rounded-full bg-cyber-blue/10 text-cyber-blue border border-cyber-blue/20 mt-0.5 shrink-0">
                ...
                <table className="w-full text-left border-collapse text-xs md:text-sm">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {servicesConfig.map((row, index) => (
                      <tr key={index} className="hover:bg-base-700/30 transition-colors">
                        <td className="py-3 px-4 font-semibold text-cyber-blue">{row.service}</td>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 backdrop-blur-sm space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-base-700 text-slate-400 border border-white/10">
              ...
              <div className="space-y-4 pt-2">
                ...
                {/* Livrable 1 */}
                <div className="p-3.5 rounded-xl bg-base-900/60 border border-white/5 space-y-2.5">
                  <span className="text-xs font-bold text-cyber-blue flex items-center gap-1.5">
                  ...
                  <div className="pl-2 space-y-2 text-[11px]">
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                        <span className="font-mono text-slate-300">apache2.conf</span>
                        <div className="flex items-center gap-2">
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/configuration principale/apache2.conf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/configuration principale/apache2.conf" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                        </div>
                      </div>
                      <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                        <span className="font-mono text-slate-300">evasive.conf</span>
                        <div className="flex items-center gap-2">
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/modules complémentaires/evasive.conf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/modules complémentaires/evasive.conf" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                        </div>
                      </div>
                      <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                        <span className="font-mono text-slate-300">reqtimeout.conf</span>
                        <div className="flex items-center gap-2">
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/modules complémentaires/reqtimeout.conf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/modules complémentaires/reqtimeout.conf" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1 pt-1">
                      ...
                      <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                        ...
                        <div className="flex items-center gap-2">
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/Vhosts/admin.rainbowbank.com.conf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/Vhosts/admin.rainbowbank.com.conf" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                        </div>
                      </div>
                      <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                        <span className="font-mono text-slate-300">extranet.rainbowbank.com.conf</span>
                        <div className="flex items-center gap-2">
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/Vhosts/extranet.rainbowbank.com.conf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-blue" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                          <a href="/docs/Projet4/Rhouma_Walid_1_config_service_web_062024/Vhosts/extranet.rainbowbank.com.conf" download className="text-slate-400 hover:text-cyber-blue" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Livrable 2 */}
                <div className="p-3.5 rounded-xl bg-base-900/60 border border-white/5 space-y-2.5">
                  <span className="text-xs font-bold text-cyber-emerald flex items-center gap-1.5">
                  ...
                  <div className="pl-2 space-y-1 text-[11px]">
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      ...
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet4/Rhouma_Walid_2_config_FTP_062024/vsftpd.txt.conf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet4/Rhouma_Walid_2_config_FTP_062024/vsftpd.txt.conf" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      <span className="font-mono text-slate-300">vsftpd_user_conf/devuser</span>
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet4/Rhouma_Walid_2_config_FTP_062024/vsftpd_user_conf/devuser" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet4/Rhouma_Walid_2_config_FTP_062024/vsftpd_user_conf/devuser" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                    <div className="flex items-center justify-between bg-base-700/80 p-1.5 rounded border border-white/5">
                      <span className="font-mono text-slate-300">vsftpd_user_conf/graphuser</span>
                      <div className="flex items-center gap-2">
                        <a href="/docs/Projet4/Rhouma_Walid_2_config_FTP_062024/vsftpd_user_conf/graphuser" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyber-emerald" title="Consulter"><Eye className="w-3.5 h-3.5" /></a>
                        <a href="/docs/Projet4/Rhouma_Walid_2_config_FTP_062024/vsftpd_user_conf/graphuser" download className="text-slate-400 hover:text-cyber-emerald" title="Télécharger"><Download className="w-3.5 h-3.5" /></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { 
                    ...
                    icon: <Lock className="w-5 h-5 text-cyber-emerald" />,
                    badge: "FTP"
                  },
                  { 
                  ...
                  <div key={i} className="p-3 rounded-xl bg-base-900/50 border border-white/5 flex items-center justify-between hover:border-white/10 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-lg bg-base-700 border border-white/5 shrink-0">
                        {item.icon}
                      </div>
                      <div>
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-base-700 text-slate-400 border border-white/5">
                      {item.badge}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-gradient-to-br from-base-700/60 via-base-700/40 to-cyber-emerald/10 border border-cyber-emerald/30 rounded-2xl p-6 backdrop-blur-sm space-y-4 shadow-lg shadow-glow">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-cyber-emerald/10 text-cyber-emerald border border-cyber-emerald/20">
                  <ShieldAlert className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-bold text-white">Évaluation du Jury</h3>
                  <p className="text-xs text-cyber-emerald font-medium">Soutenance orale (20 min)</p>
                </div>
              </div>
              ...
              <div className="space-y-2 text-xs text-slate-300">
                ...
                <div className="p-3 rounded-lg bg-base-900/60 border border-white/5 space-y-1.5">
                  <span className="font-semibold text-cyber-emerald block">Remarques de validation :</span>
        ...
        <div className="bg-base-700/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={index} className="p-4 rounded-xl bg-base-900/40 border border-white/5 flex items-start gap-3">
      ...
      <EvaluationJury
        evaluator={"Philippe Michels"}
        summary={"Soutenance orale de 20 minutes."}
        quote={"Projet valide ! Bonne maitrise de l oral et des sujets abordes. Bonne qualite des livrables. Les services Web, FTP et le filtrage reseau ont correctement ete installes et securises."}
      />
      <ProjectFooterNav current={4} />
    </div>
  );
}